...
export const PRODUCT_EMAIL_MODAL_TOGGLE = 'PRODUCT_EMAIL_MODAL_TOGGLE';
export const PRODUCT_EMAIL_MODAL_OPEN = 'PRODUCT_EMAIL_MODAL_OPEN';
export const GET_DEFAULT_CATEGORY = 'GET_DEFAULT_CATEGORY';
